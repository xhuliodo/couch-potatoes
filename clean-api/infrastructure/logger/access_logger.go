...
func NewAccessLoggerMiddleware(logger *logrus.Logger) func(next http.Handler) http.Handler {
...
func GetLogEntry(r *http.Request) logrus.FieldLogger {
	entry := middleware.GetLogEntry(r).(*AccessLoggerEntry)
	return entry.Logger
}

func LogEntrySetField(r *http.Request, key string, value interface{}) {
	if entry, ok := r.Context().Value(middleware.LogEntryCtxKey).(*AccessLoggerEntry); ok {
